...
public class RecipeController1 {
	...
	public String recipeDetail(@ModelAttribute RecipeVO rvo, @SessionAttribute(name="memberLogin", required=false) MemberVO memberLogin, Model model) {
		...
		if(memberLogin != null) {
			...
			lvo.setM_num(memberLogin.getM_num());
			log.info(Integer.toString(memberLogin.getM_num()));
